...
export const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  ...
  const icons: { [key: string]: JSX.Element } = {
    leaf: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.121 14.121a6 6 0 10-8.484-8.484 6 6 0 008.484 8.484zM12 21v-4M9 3v4M3 9h4m11 0h4m-4 12v-4m4 4v-4M9 21v-4" />,
    ...
    store: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-1 4h2" />,
