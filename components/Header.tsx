...
const Header: React.FC<HeaderProps> = ({ user, cartCount, onToggleRole, onToggleLanguage, onLogout, language, t, onCartIconClick }) => {
  return (
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 bg-brand-orange hover:bg-brand-orange-light text-white font-semibold py-2 px-3 rounded-lg shadow transition-colors"
